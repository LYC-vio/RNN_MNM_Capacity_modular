...
if __name__ == '__main__':
    ...
    parser.add_argument('--modeldir', type=str, default='data/Capacity_stim1-5_clrwhtnrm_6tasks_sequential_16perring_512_1s05s')
    ...
    tasks = ['overlap','zero_gap','gap','odr','odrd','gap500',] + ['Capacity_color_'+str(i+1)+'_stims_white_norm_stims_1s05s' for i in range(5)]

    train_sequential(args.modeldir,
                    seed=args.seed,
                    hp=hp,
                    ruleset='Capacity_stim1-5_clrwhtnrm_6tasks_1s05s',
